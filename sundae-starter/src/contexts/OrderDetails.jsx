...
export function useOrderDetails() {
    ...
    if (!contextValue) {
        throw new Error("useOrderDetail must be called from within an OrderDetailsProvider")
    }
...
export function OrderDetailsProvider(props) {
    ...
    function calculateTotalPrice(optionType) {
    ...
    const totals = {
        scoops: calculateTotalPrice("scoops"),
        toppings: calculateTotalPrice("toppings"),
    }
